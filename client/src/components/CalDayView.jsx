function CalDayView() {
    ...
    // document.getElementsByClassName('hour').style.setProperty('--content-after', '"Hello, World!"')
    let r = document.getElementsByClassName('hour')

    for (let i = 0; i < r.length; i++) {
      r[i].setAttribute('data-value', r[i].getAttribute("data-hour"));
    }
    return (
      <>
        <section>
